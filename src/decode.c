...
RvInst decode_CI16type(uint32_t instruction) {
  ...
  int imm =
      (imm_5 << 5) | (imm_7 << 7) | (imm_6 << 6) | (imm_4 << 4) | (imm_9 << 9);
  decodedInst.imm = imm;
  decodedInst.rd_rs1 = (instruction >> 7) & 0b11111;
  decodedInst.funct3 = (instruction >> 13) & 0b111;
  return decodedInst;
...
RvInst decode_CBtype(uint32_t instruction) {
  ...
  int imm =
      (imm_5 << 5) | (imm_1 << 1) | (imm_6 << 6) | (imm_3 << 3) | (imm_8 << 8);
  decodedInst.imm = imm;
...
RvInst decode_CJtype(uint32_t instruction) {
  ...
  int imm = (imm_5 << 5) | (imm_1 << 1) | (imm_7 << 7) | (imm_6 << 6) |
            (imm_10 << 10) | (imm_8 << 8) | (imm_4 << 4) | (imm_11 << 11);
  decodedInst.imm = imm;
  decodedInst.funct3 = (instruction >> 13) & 0b111;
  return decodedInst;
}
...
RvInst decode_instruction32(uint32_t instruction) {
  ...
  case 0b1010011:
    ...
    if (decodedInst.funct7 == 0b1110000 && decodedInst.rs2 == 0b00000 &&
        decodedInst.funct3 == 0b000) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct7 == 0b1110000 && decodedInst.funct3 == 0b001 &&
        decodedInst.rs2 == 0b00000) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct7 == 0b1111000 && decodedInst.funct3 == 0b000 &&
        decodedInst.rs2 == 0b00000) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct7 == 0b1110001 && decodedInst.funct3 == 0b001 &&
        decodedInst.rs2 == 0b00000) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct7 == 0b1110001 && decodedInst.rs2 == 0b00000 &&
        decodedInst.funct3 == 0b000) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct7 == 0b1111001 && decodedInst.funct3 == 0b000 &&
        decodedInst.rs2 == 0b00000) {
      decodedInst.group = NO_GROUP;
...
RvInst decode_instruction16(uint32_t instruction) {
  ...
  case 0b01000:
    ...
    if (decodedInst.imm == 0 && decodedInst.rd_rs1 == 0 &&
        decodedInst.op == 0b01 && decodedInst.funct3 == 0b000) {
      decodedInst.group = NO_GROUP;
  ...
  case 0b01011:
    decodedInst = decode_CItype(instruction);
    if (decodedInst.rd == 2 && decodedInst.op == 0b01 &&
        decodedInst.funct3 == 0b011) {
      decodedInst.group = NO_GROUP;
  ...
  case 0b10100:
    ...
    if (decodedInst.funct4 == 0b1000 && decodedInst.rs2 == 0 &&
        decodedInst.op == 0b10) {
      decodedInst.group = NO_GROUP;
    ...
    if (decodedInst.funct4 == 0b1001 && decodedInst.rs2 == 0 &&
        decodedInst.rs1 == 0 && decodedInst.op == 0b10) {
      decodedInst.group = NO_GROUP;
  ...
  case 0b01100:
    ...
    if (decodedInst.op == 0b01 && decodedInst.funct2 == 0b00 &&
        decodedInst.funct6 == 0b100011) {
      decodedInst.group = NO_GROUP;
      decodedInst.name = C_SUB;
      return decodedInst;
    }
    if (decodedInst.op == 0b01 && decodedInst.funct2 == 0b01 &&
        decodedInst.funct6 == 0b100011) {
      decodedInst.group = NO_GROUP;
      decodedInst.name = C_XOR;
      return decodedInst;
    }
    if (decodedInst.op == 0b01 && decodedInst.funct2 == 0b10 &&
        decodedInst.funct6 == 0b100011) {
      decodedInst.group = NO_GROUP;
      decodedInst.name = C_OR;
      return decodedInst;
    }
    if (decodedInst.op == 0b01 && decodedInst.funct2 == 0b11 &&
        decodedInst.funct6 == 0b100011) {
      decodedInst.group = NO_GROUP;

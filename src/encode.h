...
uint32_t inline encode_Rtype(int opcode, int rd, int funct3, int rs1, int rs2,
                             int funct7) {
  uint32_t instruction = ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
                         ((funct3 & 0b111) << 12) | ((rs1 & 0b11111) << 15) |
                         ((rs2 & 0b11111) << 20) |
                         ((funct7 & 0b1111111) << 25) | 0;
  return instruction;
}

uint32_t inline encode_R4type(int opcode, int rd, int funct3, int rs1, int rs2,
                              int funct2, int rs3) {
  uint32_t instruction = ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
                         ((funct3 & 0b111) << 12) | ((rs1 & 0b11111) << 15) |
                         ((rs2 & 0b11111) << 20) | ((funct2 & 0b11) << 25) |
                         ((rs3 & 0b11111) << 27) | 0;
  return instruction;
}

uint32_t inline encode_RAMOtype(int opcode, int rd, int funct3, int rs1,
                                int rs2, int rl, int aq, int funct5) {
  uint32_t instruction = ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
                         ((funct3 & 0b111) << 12) | ((rs1 & 0b11111) << 15) |
                         ((rs2 & 0b11111) << 20) | ((rl & 0b1) << 25) |
                         ((aq & 0b1) << 26) | ((funct5 & 0b11111) << 27) | 0;
  return instruction;
}
...
uint32_t inline encode_Itype(int opcode, int rd, int funct3, int rs1, int imm) {
  uint32_t instruction = ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
                         ((funct3 & 0b111) << 12) | ((rs1 & 0b11111) << 15) |
                         (((imm >> 0) & 0b111111111111) << 20) | 0;
  return instruction;
}

uint32_t inline encode_Stype(int opcode, int imm, int funct3, int rs1,
                             int rs2) {
  uint32_t instruction =
      ((opcode & 0b1111111) << 0) | (((imm >> 0) & 0b11111) << 7) |
      (((imm >> 5) & 0b1111111) << 25) | ((funct3 & 0b111) << 12) |
      ((rs1 & 0b11111) << 15) | ((rs2 & 0b11111) << 20) | 0;
  return instruction;
}

uint32_t inline encode_Utype(int opcode, int rd, int imm) {
  uint32_t instruction = ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
                         ((imm & 0b11111111111111111111) << 12) | 0;
  return instruction;
}

uint32_t inline encode_Btype(int opcode, int imm, int funct3, int rs1,
                             int rs2) {
  uint32_t instruction =
      ((opcode & 0b1111111) << 0) | (((imm >> 11) & 0b1) << 7) |
      (((imm >> 1) & 0b1111) << 8) | (((imm >> 5) & 0b111111) << 25) |
      (((imm >> 12) & 0b1) << 31) | ((funct3 & 0b111) << 12) |
      ((rs1 & 0b11111) << 15) | ((rs2 & 0b11111) << 20) | 0;
  return instruction;
}
...
uint32_t inline encode_Jtype(int opcode, int rd, int imm) {
  uint32_t instruction =
      ((opcode & 0b1111111) << 0) | ((rd & 0b11111) << 7) |
      (((imm >> 12) & 0b11111111) << 12) | (((imm >> 11) & 0b1) << 20) |
      (((imm >> 1) & 0b1111111111) << 21) | (((imm >> 20) & 0b1) << 31) | 0;
  return instruction;
}

uint32_t inline encode_CRtype(int op, int rs2, int rd_rs1, int funct4) {
  uint32_t instruction = ((op & 0b11) << 0) | ((rs2 & 0b11111) << 2) |
                         ((rd_rs1 & 0b11111) << 7) | ((funct4 & 0b1111) << 12) |
                         0;
  return instruction;
}

uint32_t inline encode_CRItype(int op, int rs2p, int funct2, int rd_rs1p,
                               int funct6) {
  uint32_t instruction = ((op & 0b11) << 0) | ((rs2p & 0b111) << 2) |
                         ((funct2 & 0b11) << 5) | ((rd_rs1p & 0b111) << 7) |
                         ((funct6 & 0b111111) << 10) | 0;
  return instruction;
}

uint32_t inline encode_CItype(int op, int imm, int rd_rs1, int funct3) {
  uint32_t instruction = ((op & 0b11) << 0) | (((imm >> 0) & 0b11111) << 2) |
                         (((imm >> 5) & 0b1) << 12) |
                         ((rd_rs1 & 0b11111) << 7) | ((funct3 & 0b111) << 13) |
                         0;
  return instruction;
}
...
uint32_t inline encode_CIStype(int op, int imm, int rd_rs1, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | (((imm >> 6) & 0b11) << 2) |
      (((imm >> 2) & 0b111) << 4) | (((imm >> 5) & 0b1) << 12) |
      ((rd_rs1 & 0b11111) << 7) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}

uint32_t inline encode_CISDtype(int op, int imm, int rd_rs1, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | (((imm >> 6) & 0b111) << 2) |
      (((imm >> 3) & 0b11) << 5) | (((imm >> 5) & 0b1) << 12) |
      ((rd_rs1 & 0b11111) << 7) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_CI16type(int op, int imm, int rd_rs1, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | (((imm >> 5) & 0b1) << 2) |
      (((imm >> 7) & 0b11) << 3) | (((imm >> 6) & 0b1) << 5) |
      (((imm >> 4) & 0b1) << 6) | (((imm >> 9) & 0b1) << 12) |
      ((rd_rs1 & 0b11111) << 7) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_CSStype(int op, int rs2, int imm, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | ((rs2 & 0b11111) << 2) | (((imm >> 6) & 0b11) << 7) |
      (((imm >> 2) & 0b1111) << 9) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_CIWtype(int op, int rdp, int imm, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | ((rdp & 0b111) << 2) | (((imm >> 3) & 0b1) << 5) |
      (((imm >> 2) & 0b1) << 6) | (((imm >> 6) & 0b1111) << 7) |
      (((imm >> 4) & 0b11) << 11) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}

uint32_t inline encode_CLtype(int op, int rdp, int imm, int rs1p, int funct3) {
  uint32_t instruction = ((op & 0b11) << 0) | ((rdp & 0b111) << 2) |
                         (((imm >> 2) & 0b1) << 5) | (((imm >> 6) & 0b1) << 6) |
                         (((imm >> 3) & 0b111) << 10) | ((rs1p & 0b111) << 7) |
                         ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_CSDtype(int op, int rs2p, int imm, int rs1p,
                               int funct3) {
  uint32_t instruction = ((op & 0b11) << 0) | ((rs2p & 0b111) << 2) |
                         (((imm >> 6) & 0b11) << 5) |
                         (((imm >> 3) & 0b111) << 10) | ((rs1p & 0b111) << 7) |
...
uint32_t inline encode_CBtype(int op, int imm, int rs1, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | (((imm >> 5) & 0b1) << 2) |
      (((imm >> 1) & 0b11) << 3) | (((imm >> 6) & 0b11) << 5) |
      (((imm >> 3) & 0b11) << 10) | (((imm >> 8) & 0b1) << 12) |
      ((rs1 & 0b111) << 7) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_CJtype(int op, int imm, int funct3) {
  uint32_t instruction =
      ((op & 0b11) << 0) | (((imm >> 5) & 0b1) << 2) |
      (((imm >> 1) & 0b111) << 3) | (((imm >> 7) & 0b1) << 6) |
      (((imm >> 6) & 0b1) << 7) | (((imm >> 10) & 0b1) << 8) |
      (((imm >> 8) & 0b11) << 9) | (((imm >> 4) & 0b1) << 11) |
      (((imm >> 11) & 0b1) << 12) | ((funct3 & 0b111) << 13) | 0;
  return instruction;
}
...
uint32_t inline encode_C_NOP() { return encode_CItype(0b01, 0, 0, 0b000); }
...
uint32_t inline encode_C_J(int imm) { return encode_CJtype(0b01, imm, 0b101); }
...
uint32_t inline encode_C_EBREAK(int rd_rs1) {
